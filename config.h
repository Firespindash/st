 ...
 */
static char *font = "FontForge Raize:pixelsize=17:antialias=true:autohint=true";
static char *font2[] = { "Monoid Nerd Font:pixelsize=12:antialias=true:autohint=true" };
